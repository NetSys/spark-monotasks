...
class StorageTabSuite extends FunSuite with BeforeAndAfter {
  ...
  test("task end") {
    ...
    metrics1.updatedBlocks = Some(Seq(
      (RDDBlockId(0, 100), BlockStatus(memAndDisk, 400L, 0L, 0L, None)),
      (RDDBlockId(0, 101), BlockStatus(memAndDisk, 0L, 400L, 0L, None)),
      (RDDBlockId(0, 102), BlockStatus(memAndDisk, 400L, 0L, 200L, None)),
      (RDDBlockId(1, 20), BlockStatus(memAndDisk, 0L, 240L, 0L, None))
    ))
    ...
    metrics2.updatedBlocks = Some(Seq(
      (RDDBlockId(0, 100), BlockStatus(none, 0L, 0L, 0L, None)),
      (RDDBlockId(1, 20), BlockStatus(none, 0L, 0L, 0L, None)),
      (RDDBlockId(2, 40), BlockStatus(none, 0L, 0L, 0L, None)), // doesn't actually exist
      (RDDBlockId(4, 80), BlockStatus(none, 0L, 0L, 0L, None)) // doesn't actually exist
    ))
  ...
  test("verify StorageTab contains all cached rdds") {
    ...
    val block0 = (RDDBlockId(0, 1), BlockStatus(memOnly, 100L, 0L, 0L, None))
    val block1 = (RDDBlockId(1, 1), BlockStatus(memOnly, 200L, 0L, 0L, None))
